...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(480, 180, 91, 231))
        self.layoutWidget.setObjectName("layoutWidget")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.layoutWidget)
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.add_stock = QtWidgets.QPushButton(self.layoutWidget)
        self.add_stock.setObjectName("add_stock")
        self.verticalLayout.addWidget(self.add_stock)
        self.buy_stock = QtWidgets.QPushButton(self.layoutWidget)
        self.buy_stock.setObjectName("buy_stock")
        self.verticalLayout.addWidget(self.buy_stock)
        self.sell_stock = QtWidgets.QPushButton(self.layoutWidget)
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(440, 140, 80, 531))
